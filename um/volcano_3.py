...
experiment(exp_name=f'chexpert', dataset=get_chexpert_binary,
    ood_dataset=get_chexpert_binary, mean=(0,0,0),
    std=(1,1,1), model=get_densenet121, lr=0.5e-2, ds_l=60000, ds_ood_l=60000, batch_size=64, n_canaries=10, epochs=10)
